# Smart Particles (1.12.2)

* **Summary:** A performance mod that caps the total particle count, keeping the nearest particles in the player's view visible.

**Smart Particles** is a lightweight client-side optimization mod for Minecraft **1.12.2 (Forge)** that keeps FPS stable in particle-heavy areas. Instead of blocking new particles, it keeps the most important particles visible by removing the farthest ones first.
...
Smart Particles uses Reflection to access Minecraft’s internal particle list. Each tick:
